...
public class MainMethod {
    public static void main(String[] args) {
        ...
        SinglyLinkedList sLL1 = new SinglyLinkedList();      //getting an object of the SinglyLinkedList class because other methods like insert(), deletion() is stored inside it 
